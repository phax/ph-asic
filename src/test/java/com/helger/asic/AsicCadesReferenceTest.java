...
public final class AsicCadesReferenceTest
{
  ...
  {
    try (final AsicVerifier asicVerifier = m_aAsicVerifierFactory.verify (ClassPathResource.getInputStream ("external/asic/asic-cades-test-valid.asice")))
    {
  ...
  public void testInvalidManifest () throws IOException
  {
    try
    {
      m_aAsicVerifierFactory.verify (ClassPathResource.getInputStream ("external/asic/asic-cades-test-invalid-manifest.asice"));
    ...
    try (final IAsicReader asicReader = m_aAsicRederFactory.open (ClassPathResource.getInputStream ("external/asic/asic-cades-test-invalid-manifest.asice")))
    {
  ...
  public void testInvalidSignature () throws IOException
  {
    try
    {
      m_aAsicVerifierFactory.verify (ClassPathResource.getInputStream ("external/asic/asic-cades-test-invalid-signature.asice"));
      fail ("Exception expected.");
    }
    catch (final IllegalStateException e)
    {
  ...
  public void testInvalidMetadataFile () throws IOException
  {
    try
    {
      m_aAsicVerifierFactory.verify (ClassPathResource.getInputStream ("external/asic/asic-cades-test-invalid-metadata-file.asice"));
      fail ("Exception expected.");
    }
    catch (final IllegalStateException e)
    {
  ...
  public void testInvalidSigReference () throws IOException
  {
    try
    {
      m_aAsicVerifierFactory.verify (ClassPathResource.getInputStream ("external/asic/asic-cades-test-invalid-sigreference.asice"));
      fail ("Exception expected.");
    }
    catch (final IllegalStateException e)
    {
